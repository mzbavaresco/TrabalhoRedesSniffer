...
void printIP6Header(IP6Header ip6Header)
{
    unsigned char s[2];
    unsigned int num;
    ...
    trafficClass = ip6Header.trafficClass[0]&mask;   
    flowLabel1 = ip6Header.trafficClass[1]&mask;     
    flowLabel2 = ip6Header.trafficClass[2];             
    flowLabel3 = ip6Header.trafficClass[3];             
    ...
    s[0] = (unsigned char)ip6Header.payloadLenght[1];
    s[1] = (unsigned char)ip6Header.payloadLenght[0];
    memcpy(&num, s, 4);
    printf( "\n\t-->Payload Length                 : %u\n",(unsigned short int)num);
    printf( "\t-->Hop Limit                      : %d\n",ip6Header.hopLimit);
    int tempProtocol= (int)ip6Header.nextHeader;
    string str = transportLayerProtocol(tempProtocol);
    ...
    printf(" --> (%d)\n",tempProtocol);
    printf( "\t-->Source IP                      : ");
    cout<<int_to_hex((int)ip6Header.sourceIpAddr[0])<<""<<int_to_hex((int)ip6Header.sourceIpAddr[1])<<"."<<int_to_hex((int)ip6Header.sourceIpAddr[2])<<""<<int_to_hex((int)ip6Header.sourceIpAddr[3])<<"."<<int_to_hex((int)ip6Header.sourceIpAddr[4])<<""<<int_to_hex((int)ip6Header.sourceIpAddr[5])<<"."<<int_to_hex((int)ip6Header.sourceIpAddr[6])<<""<<int_to_hex((int)ip6Header.sourceIpAddr[7])<<"."<<int_to_hex((int)ip6Header.sourceIpAddr[8])<<""<<int_to_hex((int)ip6Header.sourceIpAddr[9])<<"."<<int_to_hex((int)ip6Header.sourceIpAddr[10])<<""<<int_to_hex((int)ip6Header.sourceIpAddr[11])<<"."<<int_to_hex((int)ip6Header.sourceIpAddr[12])<<""<<int_to_hex((int)ip6Header.sourceIpAddr[13])<<"."<<int_to_hex((int)ip6Header.sourceIpAddr[14])<<""<<int_to_hex((int)ip6Header.sourceIpAddr[15]);

    printf( "\n\t-->Destination IP                 : ");
    cout<<int_to_hex((int)ip6Header.destIpAddr[0])<<""<<int_to_hex((int)ip6Header.destIpAddr[1])<<"."<<int_to_hex((int)ip6Header.destIpAddr[2])<<""<<int_to_hex((int)ip6Header.destIpAddr[3])<<"."<<int_to_hex((int)ip6Header.destIpAddr[4])<<""<<int_to_hex((int)ip6Header.destIpAddr[5])<<"."<<int_to_hex((int)ip6Header.destIpAddr[6])<<""<<int_to_hex((int)ip6Header.destIpAddr[7])<<"."<<int_to_hex((int)ip6Header.destIpAddr[8])<<""<<int_to_hex((int)ip6Header.destIpAddr[9])<<"."<<int_to_hex((int)ip6Header.destIpAddr[10])<<""<<int_to_hex((int)ip6Header.destIpAddr[11])<<"."<<int_to_hex((int)ip6Header.destIpAddr[12])<<""<<int_to_hex((int)ip6Header.destIpAddr[13])<<"."<<int_to_hex((int)ip6Header.destIpAddr[14])<<""<<int_to_hex((int)ip6Header.destIpAddr[15]);
    printf( "\n");
...
void printDetails(int x, int y)
{
    ...
    for(int i=x-1;i<y;i++)
    {
        ...
        else if(str=="IPV6")
        {
            ...
            printEthernetHeader(ethrHdr[i]);
            printIP6Header(ip6Header[i]);
            tempProtocol= (int)ip6Header[i].nextHeader;   
